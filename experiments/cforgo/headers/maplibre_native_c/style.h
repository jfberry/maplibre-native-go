...
typedef enum mln_style_source_type {
...
typedef enum mln_style_tile_source_option_field {
...
typedef enum mln_style_tile_scheme {
...
typedef enum mln_style_vector_tile_encoding {
...
typedef enum mln_style_raster_dem_encoding {
...
typedef enum mln_custom_geometry_source_option_field {
...
typedef enum mln_style_image_option_field {
...
typedef enum mln_location_indicator_image_kind {
