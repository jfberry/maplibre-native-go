...
typedef enum mln_rendered_query_geometry_type {
...
typedef enum mln_rendered_feature_query_option_field {
...
typedef enum mln_source_feature_query_option_field {
...
typedef enum mln_queried_feature_field {
...
typedef enum mln_feature_extension_result_type {
