...
typedef enum mln_animation_option_field {
...
typedef enum mln_camera_fit_option_field {
...
typedef enum mln_bound_option_field {
...
typedef enum mln_free_camera_option_field {
...
typedef enum mln_projection_mode_field {
...
typedef enum mln_map_debug_option {
...
typedef enum mln_north_orientation {
...
typedef enum mln_constrain_mode {
...
typedef enum mln_geometry_type {
...
typedef enum mln_json_value_type {
...
typedef enum mln_feature_state_selector_field {
...
typedef enum mln_feature_identifier_type {
